...
export default function SolutionClient({ slug }: SolutionProps) {
          ...
          >
            <motion.div variants={itemVariants} className="bg-gray-50 dark:bg-[#111] rounded-[2rem] p-8 md:p-12 shadow-xl shadow-gray-200/20 dark:shadow-none border border-gray-100 dark:border-white/5">
              <div className="flex items-center mb-8">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white">Solution Overview</h2>
              </div>
              <p className="text-base md:text-xl text-gray-600 dark:text-gray-400 leading-relaxed font-light mb-12">
                {solution.fullDescription}
              </p>

              <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">Compliance & Standards</h3>
              <div className="flex flex-wrap gap-4">
                {solution.compliance.map((industry, idx) => (
                  <motion.span 
                    variants={itemVariants}
                    key={idx} 
                    className="px-6 py-3 bg-white dark:bg-[#222] border border-gray-200 dark:border-white/10 rounded-full text-[#07518a] dark:text-blue-400 font-semibold shadow-sm"
                  >
                    {industry}
                  </motion.span>
                ))}
          ...
          >
            <div className="sticky top-32">
              <motion.div variants={itemVariants} className="bg-[#07518a] rounded-[2rem] p-8 shadow-2xl overflow-hidden relative">
                ...
                <h3 className="text-2xl md:text-3xl font-bold text-white mb-8 relative z-10">Core Features</h3>
