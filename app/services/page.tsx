...
export const metadata = {
  title: "Our Services | BTL Rail",
  description: "Explore our comprehensive range of railway engineering and transportation services.",
};
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-14">
        <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16">
          ...
          <p className="text-base sm:text-lg text-gray-600 dark:text-gray-400">
            End-to-end engineering and technology services tailored for the railway and transportation sectors.
          </p>
        </div>
